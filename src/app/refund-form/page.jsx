                    ...
                    <div className="container">
                        <div className="grid grid-cols-1 gap-y-10 lg:grid-cols-2">
                            <div className="text-white">
                                <h1 className="text-3xl font-bold mb-6">Refund Policy for Bhaoo INC</h1>
                                <p className="border-b pb-4 text-justify">Bhaoo INC, aims to provide excellent service and ensure customer satisfaction. Our refund and cancellation policies are designed to protect both our clients and our company. Please read through the following policy to understand how refund requests are handled.</p>
                                <div className="text-xl font-semibold mb-2 mt-4">General Refund Policy:</div>
                                <ul className="list-none mb-4">
                                    <li className="mb-2 text-justify">
                                        <strong className="text-[#374af0]">Cancellation: </strong>
                                    ...
                                    <li className="mb-2 text-justify">
                                        <strong className="text-[#374af0]">Order Inactivity: </strong>
                                    ...
                                    <li className="mb-2 text-justify">
                                        <strong className="text-[#374af0]">Final Deliverables: </strong>
                                        Refund requests will not be entertained after final files have been delivered.
                                    </li>
                                    <li className="mb-2 text-justify">
                                        <strong className="text-[#374af0]">Refund Reasons: </strong>
                                    ...
                                    <li className="mb-2 text-justify">
                                        <strong className="text-[#374af0]">Good Faith: </strong>
                                    ...
                                    <li>
                                        <strong className="text-[#374af0]">Customer Feedback: </strong>
